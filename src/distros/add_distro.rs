...
pub trait BasicDistros {
    ...
    fn add_basic_online(&mut self, homepage: &str, name: &str, pretty_name: &str, release_editions: fn() -> Result<(Vec<String>, Vec<String>), Box<dyn Error>>, url_format: &str, checksum: Checksum, arch: &str, config: Config);
    fn add_unique_online(&mut self, homepage: &str, name: &str, pretty_name: &str, release_editions: fn() -> Result<Vec<(String, Vec<String>)>, Box<dyn Error>>, url_format: &str, checksum: Checksum, arch: &str, config: Config);
}
...
pub trait AdvancedDistros {
    ...
    fn add_advanced_online(&mut self, homepage: &str, name: &str, pretty_name: &str, release_editions: fn() -> Result<(Vec<String>, Vec<String>), Box<dyn Error>>, url: fn(&str, &str, &str) -> Result<Vec<String>, Box<dyn Error>>, checksum: Checksum, arch: &str, config: Config);
    fn add_advanced_unique_online(&mut self, homepage: &str, name: &str, pretty_name: &str, release_editions: fn() -> Result<Vec<(String, Vec<String>)>, Box<dyn Error>>, url: fn(&str, &str, &str) -> Result<Vec<String>, Box<dyn Error>>, checksum: Checksum, arch: &str, config: Config);
